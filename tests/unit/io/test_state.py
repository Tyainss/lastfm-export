...
def test_read_watermark_from_ndjson_returns_max_timestamp(tmp_path: Path):
    path = tmp_path / "out.ndjson"
    path.write_text('{"timestamp_unix": 5}\n{"timestamp_unix": 1}\n', encoding="utf-8")
...
def test_read_watermark_from_csv_returns_max_timestamp(tmp_path: Path):
